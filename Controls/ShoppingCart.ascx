            ...
            <div class="column__main col-12 col-md-9">
                <div class="checkout__cart">
                        ...
                        <div class="cart__list">
                            ...
                            <div class="cart__item thead">
                                <div class="cart__inner d-grid align-items-center">
                                    <div class="cart__desc">Sản phẩm <small class="text-black-50">(<%= orderInfoList.Count %> sản phẩm)</small></div>
                                ...
                                <div class="cart__inner d-grid align-items-sm-center">
                                    ...
                                    <div class="cart__product d-grid align-items-center">
                                        ...
                                        <div class="cart__prices">
                                            <div class="price"><strong><%=string.Format("{0:N0}", orderInfo.TotalPrice) %> VNĐ</strong></div>
                                        </div>
                                        <div class="cart__qty text-sm-center">
                                            <div class="input-group block-qty-cart">
                                                ...
                                                <div class="input-group-btn">
                                                    <input type="text" name="quantity" value="1" size="1" <%--id="input-quantity"--%> class="inputQty text-center form-control" id="<%= orderInfo.ProductID %>" value="<%= orderInfo.Quantity %>">
                                                </div>
                                                <div class="input-group-btn">
                                        ...
                                        <div class="cart__action">
                                            <a href="javascript:void(0);" class="btn-delete btn-deleteCart" data-id="<%= orderInfo.ProductID %>"><i class="icon-trash"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <input type="text" name="address" value="" placeholder="Địa chỉ (ví dụ: 70 Đông Hưng Thuận 5, Phường Tân Hưng Thuận, Quận 12, Tp.HCM)" class="form-control">
                        </div>
                       <%-- <div class="row">
                ...
                <div class="cart__column-right">
                    ...
                    <div class="cart__totals bg-white bg-frame">
                        <div class="total-item d-flex">
                            ...
                            <div class="col text-end"><span><%=string.Format("{0:N0}", finalPrice) %> VNĐ</span></div>
                        </div>
                        <%-- <div class="total-item d-flex">
                        ...
                        <div class="total-item d-flex">
                            ...
                            <div class="col text-end"><strong><%=string.Format("{0:N0}", finalPrice) %> VNĐ</strong></div>
                            <input type="hidden" id="hdfTotalPrice" name="hdfTotalPrice" value="<%= string.Format("{0}",Math.Round(finalPrice)) %>" />
                        </div>
                    </div>

                    <div class="buttons text-center">
                        <a href="/checkout.html" class="btn btn-primary d-block">Thanh toán</a>
                    </div>
                </div>
            </div>
        </div>
