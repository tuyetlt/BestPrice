...
public partial class Controls_ProductCategory : System.Web.UI.UserControl
{
    ...
    protected void BindData()
    {
        ...
        if (Utils.CheckExist_DataTable(dtCat))
        {
            ...
            dtProduct = SqlHelper.SQLToDataTable(C.PRODUCT_TABLE, "ID,Name,FriendlyUrl,FriendlyUrlCategory,Gallery,Price,Price1,Price2,HashTagUrlList,AttrProductFlag", filterProduct, sort, 1, _pageSize, out _totalProduct);
